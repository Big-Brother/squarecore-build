 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`squarecore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`squarecore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'squarecore-' + name : 'squarecore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/squarecore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external squarecore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:squarecore-lib -o squarecore-lib.js';
    }
